 ...
 * 2016-03-06T17:19:43.009+05:30
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "IP2Geo", 
                  wsdlLocation = "file:/D:/AnypointStudio520/MuleWorkspace/wsclient/src/main/resources/ResolveIP.wsdl",
...
public class IP2Geo extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/AnypointStudio520/MuleWorkspace/wsclient/src/main/resources/ResolveIP.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(IP2Geo.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/AnypointStudio520/MuleWorkspace/wsclient/src/main/resources/ResolveIP.wsdl");
        }
        WSDL_LOCATION = url;
    }
